...
# The executable will be generated, e.g., `primer\_tool`.
...
# &#x20; primer\_tool <mode> -i <input> -o <output> \[options]
...
# ./primer\_tool pdr -i in.txt -o out.txt

# 

# \# Dimer optimization

# ./primer\_tool dimer -i in.txt -o out.txt -I 500

# 

# \# Off-target search

# ./primer\_tool off -i primers.fa -r ref.fa -o hits.txt -t 16
